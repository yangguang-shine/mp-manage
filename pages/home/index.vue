<template>
    <div class="shop-list-container">
        <div class="shop-list">
            <shop v-for="(shopItem, index) in shopList" :key="index" :shopItem="shopItem" :showOperation="true" @clickShopItem="toNextPage" @toDeleteShop=toDeleteShop></shop>
        </div>
    ...
    methods: {
        ...
        async toDeleteShop(shopItem) {
            try {
                ...
                await this.$fetch.post('/api/manageShop/delete', { shopID: shopItem.shopID });
                this.$hideLoading();
                await this.$showModal({
                    content: '删除成功'
                })
